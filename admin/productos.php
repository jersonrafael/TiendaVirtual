                    ...
                    while ($data = mysqli_fetch_assoc($query)) { ?>
                        <tr>
                            ...
                            <td class="row">
                                ...
                                <form method="post" class="" action="../admin_control/editar/editar.php?accion=pro&id=<?php echo $data['id']; ?>"> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea id="descripcion" class="form-control" name="descripcion" placeholder="Descripción" rows="3"></textarea>
                            </div>
                        </div>
                      <!--   <div class="col-md-6">
                            <div class="form-group">
