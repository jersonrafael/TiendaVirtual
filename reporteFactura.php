...
class PDF extends FPDF{
	...
	function Header(){
		...
		//logo
		$this->Cell(-200);
		$this->Image('assets/img/slider_img/2FB.jpg',0,0,220);
	...
	$pdf->Cell(30,9,'Precio del producto', 0,0,'C',1 );
	$pdf->Cell(20,9,'Total', 0,1,'C',1 );
	...
	while($row = $resultado->fetch_assoc()){
		...
		$pdf->Cell(45,9, $row['name'], 0,0,'C',1);

		$pdf->Cell(20,9, $row['quantity'], 0,0,'C',1 );

		$pdf->Cell(30,9, $row['price'] , 0,0,'C',1 );

		$pdf->Cell(20,9, $total += $row['price'] * $row['quantity'] , 0,1,'C',1 );
