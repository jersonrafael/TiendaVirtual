...
<head>
   ...
   <title>Bienvenido a SUPLYMAX</title>
...
<body onload="mostrarModal()">
     ...
     <div class="modal-pasarela">
       <div class="container-modal_pasarela">
           <h2>Recuerda que para Agregar productos al carrito debes tener una cuenta</h2>
           <a href="login.php" class="btn-login_modal">Inicia Sesion</a>
...
<div class="user-profile">
   ...
   <div class="acciones-usuario">
            ...
            <a href="login.php" id="btn-login">Inicia Sesion</a>
<!--       <a href="register.php" class="option-btn">register</a> -->
   ...
   <a href="categorias.php" class="categorias" hidden>Ver las categorias</a>
     ...
     <p><b>Hola, bienvenido a SUPLYMAX</b><span><?php echo $fetch_user['name']; ?></span> </p>
   ...
   ?>
      <div class="box articulo" >
         ...
         <div class="info-producto">
            ...
            <!-- <input type="submit" value="Agregar al carrito" name="" class="" hidden>
            <button class="btn-agregar_pasarela">Agregar al carrito</button> -->
         </div>
      </div>
   <?php
      };
...
<div class="shopping-cart">
   ...
   <script src="assets/js/pasarela.js"></script>
</body>
</html>